...
<table>
  ...
  <tr>
    ...
    <td><ul>
      ...
      <?php }?>
  <tr><td>이름:</td><td><?= $form->input('text',['name'=>'name'])?>
  </td></tr>
  <tr><td>크기:</td>
    ...
    <td><?=$form->select($GLOBALS['main_dishes'],['name'=>'main_dish','multiple' => true])?>
    
    </td>
    </tr>

    <tr><td>배달 주문이신가요?</td>
    <td><?=$form->input('checkbox',['name'=>'delivery','value' =>'yes'])?>네.</td></tr>
